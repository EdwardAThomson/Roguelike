...
<!-- Greedy distance-based pursuit + detection range exist (monster.js); no A*/Dijkstra, limited per-type behavior. -->
...
## 5. Multiplayer Mode `[TODO]`
<!-- Menu button shows "coming soon" only; no networking code. See multiplayer_roadmap.md. -->
...
## 6. Quest System and NPC Interactions `[TODO]`
...
## 7. Enhanced User Interface and Accessibility `[PARTIAL]`
<!-- Help screen + inventory tooltips exist; no customizable keybindings, controller support, color-blind mode, or text-size options. -->
...
## 9. Localization and Language Support `[TODO]`
...
## 10. Performance Optimization and Cross-Browser Compatibility `[TODO]`
<!-- Only canvas resizing present; no lazy loading, caching, or code splitting. -->
...
- Monsters need to be more intelligent (better pathfinding, more aware of the player). `[PARTIAL]` (greedy pursuit + detection range; no A*/Dijkstra)
